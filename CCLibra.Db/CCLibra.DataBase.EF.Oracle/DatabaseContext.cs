...
namespace CCLibra.DataBase.Oracle
{
    /// <summary>
    /// 版 本 CCLibra 框架
    /// Copyright (c) chuchao
    ...
    public class DatabaseContext : DbContext, IDisposable, IObjectContextAdapter
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            string assembleFileName = Assembly.GetExecutingAssembly().CodeBase.Replace("CCLibra.DataBase.Oracle.DLL", "CCLibra.Application.Mapping.DLL").Replace("file:///", "");
